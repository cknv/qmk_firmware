...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        LT(4, KC_TAB),KC_Q,   KC_W,   KC_F,   KC_P,   KC_G,   KC_J,   KC_L,   KC_U,   KC_Y,   KC_SCLN,KC_LBRC,KC_RBRC,KC_BSLS,          DF(3),\
        KC_DEL ,      KC_A,   KC_R,   KC_S,   KC_T,   KC_D,   KC_H,   KC_N,   KC_E,   KC_I,   KC_O,   KC_QUOT,_______, KC_ENT,        _______,\
    ...
    [4] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_AE,  KC_AA,  _______,_______,        _______,\
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_OE,  _______,_______,        _______,\
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,_______,\
        _______,_______,_______,                  _______,           _______,  _______, _______,                _______,_______,_______ \
    ),
    // Mouse nav layer
